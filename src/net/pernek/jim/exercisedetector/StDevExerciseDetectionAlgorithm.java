...
public class StDevExerciseDetectionAlgorithm implements
	...
	private List<ExerciseDetectionAlgorithmObserver> mExerciseDetectionObservers = new ArrayList<ExerciseDetectionAlgorithmObserver>();
	...
	public void addExerciseDetectionObserver(
			ExerciseDetectionAlgorithmObserver observer) {
	...
	private void notifyExerciseDetectinObservers(ExerciseState newState) {
		for (ExerciseDetectionAlgorithmObserver observer : mExerciseDetectionObservers) {
